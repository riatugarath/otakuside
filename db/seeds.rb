...
Discount.create([
    ...
    {name: "Sasuke Uchiha Naruto Mug", image: "https://res.cloudinary.com/dv1mouzbi/image/upload/v1720397347/devSources/SusukeAchNaruMugOfferPage_delzc0.png", current_price: 11.99, offer_price: 7.99, normal_price: 15.99, percentage: 27, category: "Mugs" },
    {name: "Mikasa Ackerman Shingeki no Kyojin Mug", image: "https://res.cloudinary.com/dv1mouzbi/image/upload/v1720715400/devSources/MugMikaAckeShingNoKyoOfferPage_q8lvgl.png", current_price: 10.99, offer_price: 6.99, normal_price: 18.99, percentage: 60, category: "Mugs" },
    ...
    {name: "Faye Valentine Cow Boy Bebop Doll", image: "https://res.cloudinary.com/dv1mouzbi/image/upload/v1720397569/devSources/FayeValentiCowBoyBeBoDollOfferPage_anptsd.png", current_price: 12.99, offer_price: 9.99, normal_price: 19.99, percentage: 27, category: "Dolls" },
    {name: "Roronoa Zoro One Piece Doll", image: "https://res.cloudinary.com/dv1mouzbi/image/upload/v1720565345/devSources/zoroDollOnePieOffePage_uzquio.png", current_price: 14.99, offer_price: 11.99, normal_price: 21.99, percentage: 27, category: "Dolls" },
    {name: "Dragon Ball Heroes 4th Season Manga", image: "https://res.cloudinary.com/dv1mouzbi/image/upload/v1720397472/devSources/DBHeroSeas4MangaOffPag_ananez.png", current_price: 10.99, offer_price: 6.99, normal_price: 13.99, percentage: 27, category: "Mangas" },
    {name: "Assassination Classroom 21th Volume Manga", image: "https://res.cloudinary.com/dv1mouzbi/image/upload/v1720876561/devSources/HepburnAnsatMangaOffePag_fvqqis.png", current_price: 9.99, offer_price: 5.99, normal_price: 11.99, percentage: 27, category: "Mangas" },
    {name: "Yu Yu Hakusho 14th Volume Manga", image: "https://res.cloudinary.com/dv1mouzbi/image/upload/v1720565462/devSources/yuHakuMangOffePage_s4xmuk.png", current_price: 8.99, offer_price: 4.99, normal_price: 11.99, percentage: 27, category: "Mangas" },
    ...
    {name: "Alphonse Elric Fullmetal Alchemist Pullover", image: "https://res.cloudinary.com/dv1mouzbi/image/upload/v1720716254/devSources/AlphonFullmeAlchemOFeePagCloth_h8bu6c.png", current_price: 26.99, offer_price: 19.99, normal_price: 37.99, percentage: 27, category: "Clothes" },
