...
Product.create([
    ...
    {name: "One Piece Cup", image: "https://res.cloudinary.com/dv1mouzbi/image/upload/v1713973392/devSources/onePiCupBlaStor_f8bog8.png", category: "Cups", ori_price: 17.99, sale_price: 13.99, color:"Black", description: "-" },
    {name: "Full Metal Alchemist Cup", image: "https://res.cloudinary.com/dv1mouzbi/image/upload/v1714662721/devSources/bluCupFulMetAlchStor_w7vfcg.png", category: "Cups", ori_price: 16.59, sale_price: 11.99, color:"Blue", description: "-" },
    ...
    {name: 'Gintama 75th Volume Anime', image: 'https://res.cloudinary.com/dv1mouzbi/image/upload/v1714575120/devSources/gintamVol75AniStor_us4e0t.png', category: "Animes", ori_price: 12.59, sale_price: 8.99, description: "-"},
